...
/**
 * REST controller for managing {@link com.weisen.www.code.yjf.shopmall.domain.Specifications}.
 */
@RestController
@RequestMapping("/api")
public class SpecificationsResource {
    ...
    private static final String ENTITY_NAME = "shopmallSpecifications";
    ...
    public ResponseEntity<SpecificationsDTO> updateSpecifications(@RequestBody SpecificationsDTO specificationsDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, specificationsDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<List<SpecificationsDTO>> getAllSpecifications(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
