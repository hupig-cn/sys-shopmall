...
/**
 * Integration tests for the {@Link ProdcutimageResource} REST controller.
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, ShopmallApp.class})
public class ProdcutimageResourceIT {
    ...
    private static final String DEFAULT_FILEID = "AAAAAAAAAA";
    private static final String UPDATED_FILEID = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_VIEWPLACE = "AAAAAAAAAA";
    private static final String UPDATED_VIEWPLACE = "BBBBBBBBBB";
     ...
     * if they test an entity which requires the current entity.
     */
    public static Prodcutimage createUpdatedEntity(EntityManager em) {
        Prodcutimage prodcutimage = new Prodcutimage()
    ...
    public void createProdcutimage() throws Exception {
        ...
        assertThat(testProdcutimage.getFileid()).isEqualTo(DEFAULT_FILEID);
        ...
        assertThat(testProdcutimage.getViewplace()).isEqualTo(DEFAULT_VIEWPLACE);
        assertThat(testProdcutimage.getPath()).isEqualTo(DEFAULT_PATH);
    ...
    public void getAllProdcutimages() throws Exception {
        ...
        restProdcutimageMockMvc.perform(get("/api/prodcutimages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].viewplace").value(hasItem(DEFAULT_VIEWPLACE.toString())))
    ...
    public void getProdcutimage() throws Exception {
        ...
        restProdcutimageMockMvc.perform(get("/api/prodcutimages/{id}", prodcutimage.getId()))
            ...
            .andExpect(jsonPath("$.viewplace").value(DEFAULT_VIEWPLACE.toString()))
    ...
    public void updateProdcutimage() throws Exception {
        ...
        assertThat(testProdcutimage.getFileid()).isEqualTo(UPDATED_FILEID);
        ...
        assertThat(testProdcutimage.getViewplace()).isEqualTo(UPDATED_VIEWPLACE);
        assertThat(testProdcutimage.getPath()).isEqualTo(UPDATED_PATH);
