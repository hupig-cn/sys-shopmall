...
public class CommodityResourceIntTest {
    ...
    private static final String DEFAULT_BRANDID = "AAAAAAAAAA";
    private static final String UPDATED_BRANDID = "BBBBBBBBBB";
    ...
    public void createCommodity() throws Exception {
        ...
        assertThat(testCommodity.getBrandid()).isEqualTo(DEFAULT_BRANDID);
    ...
    public void getAllCommodities() throws Exception {
        ...
        restCommodityMockMvc.perform(get("/api/commodities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].brandid").value(hasItem(DEFAULT_BRANDID.toString())))
    ...
    public void getCommodity() throws Exception {
        ...
        restCommodityMockMvc.perform(get("/api/commodities/{id}", commodity.getId()))
            ...
            .andExpect(jsonPath("$.brandid").value(DEFAULT_BRANDID.toString()))
    ...
    public void updateCommodity() throws Exception {
        ...
        assertThat(testCommodity.getBrandid()).isEqualTo(UPDATED_BRANDID);
